...
const uint8_t PTAD::Dialog::messages[] =
{
  ...
  0x1C,0x2B,0x22,0x2D,0x22,0x1C,0x1A,0x25,0x0A,0x21,0x22,0x2D,0x00,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,0x0A,
...
const uint8_t PTAD::Dialog::messageSizes[] = {24,24,23,14,13,19,15,14,9,8,24,24,21,23,23,10,5,13,24,23,11,9,9,21,22,22,24,14,24,18,23,24,18,23,24,21,24,24,22,19,18,18,24};
...
bool PTAD::Dialog::updateMessage(bool skippable)
{
  ...
  if (bufferPos != messageSize - (counter / messageSpeed))
  {
    if (buffer[bufferPos] != PTAD::FONT_SPACE)
      PTAD::Music::playSFX(PTAD::Music::SFX_DIALOG);
