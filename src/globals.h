...
namespace PTAD
{
  ...
  static constexpr uint32_t MEMORY_BATTLE_ANIMATIONS_SIZE = 8192;
	...
	static constexpr uint32_t MEMORY_MAP_PASSABILITY_SIZE = 512;
  ...
  static constexpr uint32_t MEMORY_MAP_SIZE = MEMORY_MAP_DATA_SIZE + MEMORY_MAP_PASSABILITY_SIZE + MEMORY_MAP_CHUNKS_SIZE + MEMORY_MAP_CHUNKS_SIZE + MEMORY_MAP_SPRITES_SIZE + MEMORY_MAP_TILEDATA_SIZE;
  ...
  static constexpr uint32_t MEMORY_MAP_PASSABILITY_OFFSET = MEMORY_MAP_DATA_OFFSET + MEMORY_MAP_DATA_SIZE;
